    ...
    Object.defineProperty(CartRouter.prototype, "postCart", {
        ...
        value: function () {
            ...
            this.apiRouter.post('/', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, carts_dao_mongo_1.cartsDao.save()];
                        case 1:
                            newCartId = _a.sent();
                            if (newCartId == null)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, carts_dao_mongo_1.cartsDao.getById(cartId)];
                        case 1:
                            cart = _a.sent();
                            if (!cart)
            ...
            this.apiRouter.delete('/:id', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            cartId = req.params.id;
                            return [4, carts_dao_mongo_1.cartsDao.deleteById(cartId)];
                        case 1:
                            success = _a.sent();
                            if (success == null)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4, carts_dao_mongo_1.cartsDao.addProductById(cartId, productId)];
                        case 1:
                            success = _a.sent();
                            if (!success)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            productId = req.body.id;
                            return [4, carts_dao_mongo_1.cartsDao.removeProductById(cartId, productId)];
                        case 1:
                            success = _a.sent();
                            if (!success)
