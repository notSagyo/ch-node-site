...
var carts_dao_mongo_1 = require("../../daos/carts-dao-mongo");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, tests_1.testFunction)('save()', function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, carts_dao_mongo_1.cartsDao.save({ id: '0', products: [], timestamp: Date.now() })];
                            case 1:
                                _a.sent();
                                return [4, carts_dao_mongo_1.cartsDao.save({ id: '1', products: [], timestamp: Date.now() })];
                            case 2:
                                _a.sent();
                                return [4, carts_dao_mongo_1.cartsDao.save({ id: '2', products: [], timestamp: Date.now() })];
                            case 3:
                                _a.sent();
                                return [2];
                        }
            ...
            case 1:
                ...
                return [4, (0, tests_1.testFunction)('getAll()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_mongo_1.cartsDao.getAll()];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    return [2];
            ...
            case 2:
                ...
                return [4, (0, tests_1.testFunction)('getById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_mongo_1.cartsDao.getById('0')];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    return [2];
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    if (!newCartProd)
                                        return [2];
                                    return [4, carts_dao_mongo_1.cartsDao.updateById('0', { products: [newCartProd] })];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_mongo_1.cartsDao.getAll()];
                                case 2:
                                    updated = _a.sent();
            ...
            case 4:
                ...
                return [4, (0, tests_1.testFunction)('deleteById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_mongo_1.cartsDao.deleteById('0')];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_mongo_1.cartsDao.getAll()];
                                case 2:
            ...
            case 5:
                ...
                return [4, (0, tests_1.testFunction)('deleteAll()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_mongo_1.cartsDao.deleteAll()];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_mongo_1.cartsDao.getAll()];
                                case 2:
