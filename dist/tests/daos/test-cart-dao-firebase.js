...
var carts_dao_firebase_1 = require("../../daos/carts-dao-firebase");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, tests_1.testFunction)('save()', function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, carts_dao_firebase_1.cartsDao.save({ id: '0', products: [], timestamp: Date.now() })];
                            case 1:
                                _a.sent();
                                return [4, carts_dao_firebase_1.cartsDao.save({ id: '1', products: [], timestamp: Date.now() })];
                            case 2:
                                _a.sent();
                                return [4, carts_dao_firebase_1.cartsDao.save({ id: '2', products: [], timestamp: Date.now() })];
                            case 3:
                                _a.sent();
                                return [2];
                        }
            ...
            case 1:
                ...
                return [4, (0, tests_1.testFunction)('getAll()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_firebase_1.cartsDao.getAll()];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    return [2];
            ...
            case 2:
                ...
                return [4, (0, tests_1.testFunction)('getById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_firebase_1.cartsDao.getById('0d59a48a-31ed-4b0b-ad17-60a35d9cbafc')];
                                case 1:
                                    res = _a.sent();
                                    console.log(res);
                                    return [2];
            ...
            case 3:
                ...
                return [4, (0, tests_1.testFunction)('updateById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    newCartProd = (0, parsers_1.parseCartProduct)({ id: (0, uuid_1.v4)(), quantity: 1 });
                                    if (!newCartProd)
                                        return [2];
                                    return [4, carts_dao_firebase_1.cartsDao.updateById('0d59a48a-31ed-4b0b-ad17-60a35d9cbafc', { products: [newCartProd] })];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_firebase_1.cartsDao.getAll()];
                                case 2:
                                    updated = _a.sent();
            ...
            case 4:
                ...
                return [4, (0, tests_1.testFunction)('addProductById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_firebase_1.cartsDao.addProductById('0d59a48a-31ed-4b0b-ad17-60a35d9cbafc', '6666666')];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_firebase_1.cartsDao.getAll()];
                                case 2:
            ...
            case 5:
                ...
                return [4, (0, tests_1.testFunction)('removeProductById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_firebase_1.cartsDao.removeProductById('0d59a48a-31ed-4b0b-ad17-60a35d9cbafc', '6666666')];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_firebase_1.cartsDao.getAll()];
                                case 2:
            ...
            case 6:
                ...
                return [4, (0, tests_1.testFunction)('deleteById()', function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, carts_dao_firebase_1.cartsDao.deleteById('0')];
                                case 1:
                                    _a.sent();
                                    return [4, carts_dao_firebase_1.cartsDao.getAll()];
                                case 2:
