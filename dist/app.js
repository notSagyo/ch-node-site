...
var container_fs_1 = require("./containers/container-fs");
// INIT ======================================================================//
// Constants
var PORT = 8080;
var app = express();
...
ioServer.on('connection', function (socket) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        updateProducts = function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, product_1.productsTable.find({})];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, product_1.productsTable.insert(parsedProduct)];
                    case 1:
                        _a.sent();
                        updateProducts();
                        return [2 /*return*/];
