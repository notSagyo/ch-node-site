...
// Normalizr schemas
// const normalizrAuthorSchema = new normalizr.schema.Entity(
//   'authors',
//   {},
//   { idAttribute: 'email' }
// );
// const normalizrMessageSchema = new normalizr.schema.Entity('messages', {
...
socket.on('messages_updated', (normalizedMessages) => {
  ...
  const denormalizedMessages = normalizedMessages;
  ...
  // compressionRate &&
  //   (compressionRate.innerHTML = Math.max(
  //     0,
  //     getCompressionRate(normalizedMessages, denormalizedMessages)
  //   ));
...
messageForm &&
  messageForm.addEventListener('submit', (e) => {
    ...
    const message = {
      time: Date.now(),
      author: document.getElementById('messageAuthorUsername').value,
      // author: {
